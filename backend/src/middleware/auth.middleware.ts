  ...
  class AuthMiddleWare {
    ...
    static createRefreshToken(user: { id: string, tokenVersion: number }) {
      return jwt.sign({ userId: user.id, tokenVersion: user.tokenVersion }, process.env.JWT_SECRET as string, {
        expiresIn: "7d",
      });
    }

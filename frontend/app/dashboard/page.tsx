                                        ...
                                        >
                                            <div className="aspect-video bg-black relative">
                                                ...
                                                {stream.isLive ? (
                                                    ...
                                                    <span className="absolute top-2 left-2 bg-yellow-600 text-white px-2 py-1 text-xs rounded font-semibold">⏸️ PENDING</span>
                                                )}
                                            </div>
                                            <div className="p-4">
                                                ...
                                                <div className="flex items-center justify-between mt-2">
                                                    <p className="text-xs text-gray-500">
                                                        {stream.isLive ? (
                                                            <>👁️ {viewerCounts[stream.id] ?? stream.viewerCount ?? 0} viewers</>
                                                        ) : (
                                                            <>📝 Ready to start</>
                                                        )}
                                                    </p>
